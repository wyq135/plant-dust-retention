...
| v5 下载 | ⏳ | 待用户手动下载（7优先级，P0~34篇优先，已完成三批） |
...
| v5 后续提取 | ⏳ | 待用户下载后续论文（P1-P4c，~200篇） |

## 关键文件

- 核心数据集: `C:\Users\政委\Desktop\2026\plant_dust_v2\dataset.csv` (4346条, needs_manual_review=833, 物种552, 城市84, 论文203)
- v5下载清单: `C:\Users\政委\Desktop\2026\plant_dust_v2\_download_list_v5.md` (~260篇，7优先级，~58新城市)
- downloaded/ 6状态分类: _待处理(0 PDF ✅) | _需重下(22 .bin CAJ) | _需VLM(6篇) | _待人工(1篇崔洁) | _已入库(248) | _已排除(24)
...
- **v5论文下载**: ~240-270篇待用户下载（7优先级，见`_download_list_v5.md`）
- needs_manual_review: 442条（分11类，见CLAUDE.md数据质量）
- `_需重下/`: **22个.bin CAJ文件** → 需在知网重下PDF
- `_待人工/`: 王琴2017 + 曹雪2020 + 谭志海 + 李辰 → 需人工摘录
- `_需VLM/`: ~7篇图片表格论文 → VLM精度有限，柱状图跳过
