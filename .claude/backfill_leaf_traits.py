...
GENUS_TRAITS = GENUS_TRAITS = {
    ...
    # === v5第四批新增属 (2026-06-24 自动补全) ===
    'Caragana': {
        'leaf_shape': '偶数羽状复叶; 小叶椭圆形/倒卵形; 纸质; 全缘; 叶轴常硬化成刺',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '幼叶被柔毛; 老叶无毛或下面有毛',
        'source': 'FRPS Vol.42(1)',
    },
    'Larix': {
        'leaf_shape': '条形; 扁平柔软; 螺旋状排列或簇生; 落叶性',
        'leaf_surface': '淡绿色; 中脉在上面凹下',
        'trichomes': '无毛(裸子植物)',
        'source': 'FRPS Vol.7',
    },
    'Hedera': {
        'leaf_shape': '卵形/三角状卵形; 革质; 全缘或3-5浅裂; 不育枝叶常分裂',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛或幼时被星状柔毛',
        'source': 'FRPS Vol.54',
    },
    'Ziziphus': {
        'leaf_shape': '卵形/椭圆形; 革质; 边缘有钝锯齿; 三出脉',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.48(1)',
    },
    'Indocalamus': {
        'leaf_shape': '宽披针形/长椭圆形; 竹亚科; 纸质; 全缘; 大型叶',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或下面被微毛',
        'source': 'FRPS Vol.9(1)',
    },
    'Phyllostachys': {
        'leaf_shape': '披针形/狭披针形; 竹亚科; 纸质; 全缘; 平行脉',
        'leaf_surface': '上面深绿色; 下面淡绿色或灰白色',
        'trichomes': '无毛或下面基部有毛',
        'source': 'FRPS Vol.9(1)',
    },
    'Alternanthera': {
        'leaf_shape': '椭圆形/披针形/倒卵形; 纸质; 全缘; 对生',
        'leaf_surface': '上面深绿色或紫红色; 下面淡绿色',
        'trichomes': '无毛或疏被柔毛',
        'source': 'FRPS Vol.25(2)',
    },
    'Caryota': {
        'leaf_shape': '二回羽状复叶; 小叶三角形/斜扇形; 革质; 棕榈科; 边缘有不规则啮蚀状齿',
        'leaf_surface': '上面深绿色有光泽; 下面灰白色',
        'trichomes': '无毛',
        'source': 'FRPS Vol.13(1)',
    },
    'Taxus': {
        'leaf_shape': '条形/线形; 螺旋状排列; 常绿; 基部扭转成二列',
        'leaf_surface': '上面深绿色有光泽; 下面有两条灰绿色气孔带',
        'trichomes': '无毛(裸子植物)',
        'source': 'FRPS Vol.7',
    },
    'Aesculus': {
        'leaf_shape': '掌状复叶; 小叶5-7枚; 倒卵形/椭圆状披针形; 纸质; 边缘有锯齿',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.46',
    },
    'Celastrus': {
        'leaf_shape': '椭圆形/宽卵形; 纸质; 边缘有锯齿; 互生',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.45(3)',
    },
    'Campsis': {
        'leaf_shape': '奇数羽状复叶; 小叶卵形/卵状披针形; 纸质; 边缘有锯齿',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.69',
    },
    'Cleidiocarpon': {
        'leaf_shape': '椭圆形/倒卵状椭圆形; 革质; 全缘; 互生',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '幼叶被星状毛; 老叶无毛',
        'source': 'FRPS Vol.44(3)',
    },
    'Spathodea': {
        'leaf_shape': '奇数羽状复叶; 小叶椭圆形/卵状披针形; 革质; 全缘',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.69',
    },
    'Salvia': {
        ...
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '两面被柔毛或下面密被柔毛',
        'source': 'FRPS Vol.66',
    },
    'Tagetes': {
        'leaf_shape': '羽状深裂; 裂片线形/披针形; 纸质; 有油腺点',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛; 有特殊气味',
        'source': 'FRPS Vol.75',
    },
    'Cydonia': {
        'leaf_shape': '卵形/椭圆形; 纸质; 全缘; 幼叶背面密被绒毛',
        'leaf_surface': '上面深绿色; 下面密被黄褐色绒毛',
        'trichomes': '叶背密被黄褐色绒毛',
        'source': 'FRPS Vol.36',
    },
    'Sasa': {
        'leaf_shape': '披针形/宽披针形; 竹亚科; 纸质; 全缘',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛',
        'source': 'FRPS Vol.9(1)',
    },
    'Sasaella': {
        'leaf_shape': '披针形/卵状披针形; 竹亚科; 纸质; 全缘; 小型竹',
        'leaf_surface': '上面深绿色; 下面淡绿色; 斑叶品种有白色条纹',
        'trichomes': '无毛或疏被柔毛',
        'source': 'FRPS Vol.9(1)',
    },
    # === v5第三批新增属 (2026-06-24) ===
    'Allamanda': {
        'leaf_shape': '椭圆形/倒卵状披针形; 革质; 全缘; 轮生或对生',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.63',
    },
    'Chrysanthemum': {
        'leaf_shape': '卵形/披针形; 纸质; 羽状浅裂或深裂; 互生',
        'leaf_surface': '上面深绿色; 下面灰白色',
        'trichomes': '密被柔毛或蛛丝状毛',
        'source': 'FRPS Vol.76(1)',
    },
    'Calystegia': {
        'leaf_shape': '卵形/三角状卵形; 纸质; 全缘或浅裂; 基部心形或戟形',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或疏被柔毛',
        'source': 'FRPS Vol.64(1)',
    },
    'Vitis': {
        'leaf_shape': '卵形/宽卵形; 纸质; 3-5浅裂或不裂; 边缘有锯齿; 掌状脉',
        'leaf_surface': '上面深绿色; 下面淡绿色或密被绒毛',
        'trichomes': '幼叶两面被蛛丝状绒毛; 老叶下面被绒毛或无毛',
        'source': 'FRPS Vol.48(2)',
    },
    'Pharbitis': {
        'leaf_shape': '宽卵形/心形; 纸质; 全缘或3裂; 基部心形',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '两面被柔毛',
        'source': 'FRPS Vol.64(1)',
    },
    'Murraya': {
        'leaf_shape': '奇数羽状复叶; 小叶卵形/椭圆形; 革质; 全缘',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色; 有油腺点',
        'trichomes': '无毛',
        'source': 'FRPS Vol.43(2)',
    },
    'Eurya': {
        'leaf_shape': '椭圆形/倒卵状椭圆形; 革质; 边缘有钝锯齿; 二列互生',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛',
        'source': 'FRPS Vol.50(1)',
    },
    'Parakmeria': {
        'leaf_shape': '椭圆形/倒卵状椭圆形; 革质; 全缘; 互生常簇生枝顶',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛',
        'source': 'FRPS Vol.30(1)',
    },
    'Saraca': {
        'leaf_shape': '偶数羽状复叶; 小叶卵形/椭圆状披针形; 革质; 全缘',
        'leaf_surface': '上面深绿色有光泽; 下面淡绿色',
        'trichomes': '无毛; 嫩叶常呈紫红色下垂',
        'source': 'FRPS Vol.39',
    },
    'Xanthoceras': {
        'leaf_shape': '奇数羽状复叶; 小叶卵形/椭圆状披针形; 纸质; 边缘有锐锯齿',
        'leaf_surface': '上面深绿色; 下面淡绿色',
        'trichomes': '无毛或下面沿脉有毛',
        'source': 'FRPS Vol.47(1)',
    },
